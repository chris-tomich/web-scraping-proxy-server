...
fn main() {
    let file_descriptor : libc::c_int;
    let set_socket_result : libc::c_int;
    let bind_result : libc::c_int;
    let listening_result : libc::c_int;
    let new_socket : libc::c_int;
    ...
    unsafe {
        ...
        set_socket_result = libc::setsockopt(file_descriptor, libc::SOL_SOCKET, libc::SO_REUSEADDR | libc::SO_REUSEPORT, socket_opt_ptr, size_of::<i32>() as u32);
        ...
        let amount_read = libc::read(new_socket, buffer_ptr, 1024);
